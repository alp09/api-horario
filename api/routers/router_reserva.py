...
def get_todos():
	reservas_encontradas = servicio_reserva.get_todos()
...
def actualizar_por_codigo(id_reserva: int, reserva_editada: ReservaIn):
	reserva_actualizada = servicio_reserva.actualizar_por_codigo(id_reserva, reserva_editada)
